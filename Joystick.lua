...
function Joystick:draw()
    ...
    if self.type=="shoot" then
        ...
        if math.abs(v1.x+v1.y)>0 then
            ...
            self.c=self.c+1
            if self.c>12 then
                local randomVolume = math.random(100,400) * 0.001
                local randomPitch = math.random(15,20) * 0.1
                sound(asset.downloaded.Game_Sounds_One.Dropzone, randomVolume, randomPitch)
